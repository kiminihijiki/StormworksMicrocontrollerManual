...
This repository is the integration entry point for three Stormworks references. It is not a second source of truth for DSL, gate definitions, XML conversion, Lua runtime facts, or part data.
...
- Use [storm-microcontroller-language](https://github.com/nona-takahara/storm-microcontroller-language) for `spec`, `check-dsl`, and `typecheck-dsl`.
...
- Do not copy the reference repository's definitions into this repository.
